...
"""autogenerated by genpy from avt_341_msgs/DwaTrajectory.msg. Do not edit."""
import codecs
import sys
...
class DwaTrajectory(genpy.Message):
  _md5sum = "02949f28799d0ba3776b1635badb3cca"
  _type = "avt_341_msgs/DwaTrajectory"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message contains information on a simulated trajectory generated and
...
float64 deviation_cost"""
  __slots__ = ['path','objective','cost']
  _slot_types = ['nav_msgs/Path','avt_341_msgs/DwaObjective','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DwaTrajectory, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.path is None:
        self.path = nav_msgs.msg.Path()
      if self.objective is None:
        self.objective = avt_341_msgs.msg.DwaObjective()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7d().pack(_x.objective.goal_cost, _x.objective.obstacle_cost, _x.objective.segmentation_cost, _x.objective.heading_cost, _x.objective.speed_cost, _x.objective.deviation_cost, _x.cost))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.objective.goal_cost, _x.objective.obstacle_cost, _x.objective.segmentation_cost, _x.objective.heading_cost, _x.objective.speed_cost, _x.objective.deviation_cost, _x.cost,) = _get_struct_7d().unpack(str[start:end])
      return self

...
def generate_launch_description():
    ...
    launch_description = LaunchDescription([
        ...
        DeclareLaunchArgument("dwa_lat_accel_max", default_value="9.81", description="Maximum allowed lateral acceleration. Sampled trajectories exceeding this lateral acceleration are ignored (this setting can be used to guarantee planning within the linear region of the motion model)."),
        ...
        DeclareLaunchArgument("dwa_obs_search", default_value="adaptive", description="Obstacle search radius modality - may be 'fixed' for a fixed search radius specified by the user or 'adaptive' for a search radius based on the vehicle motion model."),
        DeclareLaunchArgument("dwa_search_radius", default_value="10.0", description="Obstacle search radius. Obstacles farther than the search radius are ignored when computing the objective function. Lower values improve the performance of the planner on fine occupancy grids."),
        ...
        DeclareLaunchArgument('time_to_max_brake', default_value='0.1', description="Time in seconds to go from 0 to maximum braking"),
        DeclareLaunchArgument('time_to_max_throttle', default_value='0.1', description="Time in seconds to go from 0 to maximum throttle"),
        ...
        DeclareLaunchArgument('turn_off_velocity_overshoot_corrector', default_value='True', description="Controller will limit the speed to try to keep the lateral g-forces under this amount. In fractional units of 9.806 m/s^2"),
        ...
        Node(
            ...
            parameters=[{
                ...
                'time_to_max_throttle': launch.substitutions.LaunchConfiguration('time_to_max_throttle'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'dwa_lat_accel_max': launch.substitutions.LaunchConfiguration('dwa_lat_accel_max'),
                ...
                'dwa_obs_search': launch.substitutions.LaunchConfiguration('dwa_obs_search'),
                'dwa_search_radius': launch.substitutions.LaunchConfiguration('dwa_search_radius'),

...
def generate_launch_description():
	...
	launch_description = LaunchDescription([
        ...
        DeclareLaunchArgument('name', default_value="AGV1", description="Name of the Vehicle"),
		...
		Node(
			package='avt_341',
			executable='test_target_detection_node',
			name='test_target_detection_node',
			output='screen',
			parameters=[{'detection_range': launch.substitutions.LaunchConfiguration('detection_range')
			}],
		),
		Node(
			package='avt_341',
			...
			parameters=[{
                ...
                'follow_scale': launch.substitutions.LaunchConfiguration('follow_scale')
			}],
		),
		Node(
			package='avt_341',

...
void FollowerStatusCallback(avt_341::msg::BoolPtr msg)
{
...
int main(int argc, char *argv[])
{
    ...
    auto leader_status_sub = node->create_subscription<avt_341::msg::Bool>("avt_341/follower_status",1,FollowerStatusCallback);

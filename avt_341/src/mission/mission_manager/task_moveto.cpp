...
: Task(manager, sender, id, formation_def), x_offset_(x_offset), y_offset_(y_offset), d_approach_(d_approach > 0.0 ? d_approach : -1.0) {
...
void MoveTo::init_() {
    ...
    mgr->publishGoal(core::ToNavGoal(target_pose, d_approach_));

...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<bool>("liorf/calculateInitRollPitch", calculateInitRollPitch, true);
        nh.param<int>("liorf/initRollPitchWindow", initRollPitchWindow, 50);
        ...
        nh.param<bool>("liorf/isImuNed", isImuNed, false);

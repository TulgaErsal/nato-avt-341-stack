...
double w_prediction_horizon_anchor;
int max_num_obs;
int max_num_seg;
double min_speed;
double max_speed;
...
jl_function_t* j_set_use_adaptive_prediction_horizon = NULL;
jl_function_t* j_set_min_prediction_horizon_distance = NULL;
jl_function_t* j_set_prediction_horizon_time_max = NULL;
jl_function_t* j_set_w_prediction_horizon_anchor = NULL;

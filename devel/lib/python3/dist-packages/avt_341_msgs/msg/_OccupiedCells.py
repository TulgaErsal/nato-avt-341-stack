...
"""autogenerated by genpy from avt_341_msgs/OccupiedCells.msg. Do not edit."""
import codecs
import sys
...
class OccupiedCells(genpy.Message):
  _md5sum = "37ed2b2acb76839816aaa89a306fe0dc"
  _type = "avt_341_msgs/OccupiedCells"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nav_msgs/MapMetaData','avt_341_msgs/OccupiedCell[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OccupiedCells, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.cells:
        _x = val1
        buff.write(_get_struct_2Ib().pack(_x.x_index, _x.y_index, _x.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = avt_341_msgs.msg.OccupiedCell()
        _x = val1
        start = end
        end += 9
        (_x.x_index, _x.y_index, _x.data,) = _get_struct_2Ib().unpack(str[start:end])
